...
def word_graph(bigram_document = bigram_document,min_count=2,min_sim=0.3,noun=True,):

    mat, vocab_idx, idx_vocab = vectorize_sents(
        bigram_document,min_count=min_count, noun=noun)
